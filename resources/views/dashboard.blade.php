                    ...
                    @foreach ($posts as $post)
                        <div class="border-b border-grey-lighter pb-8">
                            ...
                            <a href="{{ route('dashboard.post.show', ['post' => $post->id ]) }}"
                                class="block font-body text-lg font-semibold text-primary transition-colors hover:text-green dark:text-white dark:hover:text-secondary">{{ Str::limit($post->title,80) }}</a>
